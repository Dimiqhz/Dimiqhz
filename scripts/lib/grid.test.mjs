...
import { renderAbout, renderGraph, renderHeader, renderProjectCell, renderPromptStrip, renderStack, renderStats } from './assets.mjs';
...
test('every asset adapts to a light page', () => {
  ...
  const assets = {
    ...
    row: renderProjectCell({ name: 'a', description: 'b', language: 'Shell' }, 'left'),
  };
