...
import { TEXT_X, renderAbout, renderGraph, renderHeader, renderProjectCell, renderPromptStrip, renderStack, renderStats } from './assets.mjs';
...
const panels = () => ({
  ...
  project: renderProjectCell({ name: 'One', description: 'a row', language: 'Shell', stars: 1 }, 'left'),
