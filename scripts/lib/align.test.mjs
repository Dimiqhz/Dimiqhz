...
import { TEXT_X, renderAbout, renderGraph, renderHeader, renderProjectPair, renderPromptStrip, renderStack, renderStats } from './assets.mjs';
...
const panels = () => ({
  ...
  project: renderProjectPair([{ name: 'One', description: 'a row', language: 'Shell', stars: 1 }]),
